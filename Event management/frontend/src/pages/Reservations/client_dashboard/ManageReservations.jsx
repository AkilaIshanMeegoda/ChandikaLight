  ...
  return (
    <div className="px-4 pb-4 my-4">
      <div className="flex justify-between p-4 mb-6 shadow-2xl rounded-xl bg-client-brown">
        <h2 className="text-3xl font-bold text-white ">Manage Your Reservations</h2>
        <div className="flex">
      ...
      <div className="flex justify-between">
        ...
        >
            <Button className="mb-4 shadow-lg bg-client-brown rounded-2xl">Create Reservation</Button>
        </Link>
      ...
      <Table >
        ...
        {currentPosts?.map((reservation, index) => (
          <Table.Body className={`divide-y ${index % 2 === 0 ? 'bg-white dark:bg-gray-700' : 'bg-client-yellow dark:bg-gray-800'}`} key={reservation._id}>
          <Table.Row className="dark:border-gray-700">
              ...
              <Table.Cell>
                ...
                >
                  <button
                  className="px-4 py-1 ml-5 font-semibold text-white bg-blue-600 rounded-sm hover:bg-sky-600"
                >
                  Edit
                </button>
                </Link>

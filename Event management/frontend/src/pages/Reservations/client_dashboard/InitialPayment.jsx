      ...
      <div className="my-4 px-44">
        ...
        <div className="flex">
          ...
          <form onSubmit={handleCreateReservation}>
            ...
            <p className="mt-8 ml-24 font-bold text-center text-red-600">Minimum payment amount is Rs.1000/=</p>
            <p className="ml-24 font-bold text-center text-red-600 ">(Please upload jpg , png , jpeg types only.)</p>
            <Button className="mt-4 shadow-xl ml-52 bg-client-brown" type="submit" disabled={!fileUploaded}>
              Upload Slip
            </Button>
          </form>
        </div>

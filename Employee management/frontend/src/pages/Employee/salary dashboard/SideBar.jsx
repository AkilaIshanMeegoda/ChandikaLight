      ...
      <div style={{ height: '95vh', backgroundColor: '#0C2D57' }} className="rounded-2xl bg-sidebar-blue">
        <Sidebar.Items className="bg-sidebar-blue rounded-2xl" style={{ textAlign: 'left' }}>
          <Sidebar.ItemGroup>
            ...
            <Sidebar.Item href="/admin/dashboard/manage-salary" icon={CgFileDocument} className="hover:bg-sidebar-orange" style={{ color: 'white' }}>
              Employee Salary
            </Sidebar.Item>
            <Sidebar.Item href="/admin/dashboard/AddSalary" icon={GiConfirmed} className="hover:bg-sidebar-orange" style={{ color: 'white' }}>
              Add Salary 
            </Sidebar.Item>
